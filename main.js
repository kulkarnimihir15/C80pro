...
function submit(){
    ...
    var legnth_of_array=name_of_student_array.length;
    console.log (legnth_of_array);
    for (var b=0; b<legnth_of_array;b++){
...
function sorting(){
    ...
    console.log(legnth_of_array);
    for (var b=0; b<legnth_of_array;b++){
        display_student_array_sorting.push("<h4> name-" +name_of_student_array[b] +"</h4>");
